...
function buildRequest(input: {
  ...
  const body: WorldVisualAiImageGenerationRequestBody = {
    ...
    responseContract: {
      ...
      minimumWidth: outputSize.width,
      minimumHeight: outputSize.height,
      canShowToPlayer: false,
      mustPersistAsAiImageCandidate: true,
      mustPassVisualJudge: true,
      tags: [
        "ai_image_generation_response_contract",
        "image_url_required",
        "image_format_required",
        "width_height_required",
        "license_required",
        "originality_confirmed_required",
