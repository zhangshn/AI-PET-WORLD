...
import { INITIAL_HOME_MAP_COLUMNS, INITIAL_HOME_MAP_ID, INITIAL_HOME_MAP_NAME, INITIAL_HOME_MAP_ROWS, INITIAL_HOME_TILE_SIZE } from "./initial-home-map-constants"
...
export const INITIAL_HOME_MAP_LAYOUT = {
  ...
  groundAssetId: "groundGrassBase01",
  pathAssetId: "pathDirtHorizontal01",
