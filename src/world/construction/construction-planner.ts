...
export function createInitialConstructionPlan(
  ...
  return {
    ...
    houseStyle: {
      preferenceId: "legacy-initial-house-style",
      ...
      spatialPreference: {
        ...
        maintenanceRisk: 0.2,
        tags: ["legacy_initial_house_style"],
      },
      scalePreference: "conservative",
      resourcePosture: "stable",
      sourceBiome: "grassland",
      personalityDrivers: ["quietMaintainer"],
      resourceDrivers: ["legacy_initial_plan"],
      styleReason: "legacy_initial_plan",
      styleTags: ["legacy_initial_house_style"],
    },
    styleReason: "legacy_initial_plan",
    styleTags: ["legacy_initial_house_style"],
