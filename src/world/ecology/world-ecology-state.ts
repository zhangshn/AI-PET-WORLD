...
function buildPlantFact(homeMapState: HomeMapState): WorldEcologyFact {
  ...
  return {
    ...
    kind: "plant",
    label: "植物生长",
    status: strength >= 60 ? "stable" : strength >= 30 ? "observable" : "latent",
...
function buildInsectTraceFact(homeMapState: HomeMapState): WorldEcologyFact {
  ...
  return {
    ...
    kind: "insect_trace",
    label: "昆虫迹象",
    status: strength >= 70 ? "emerging" : strength >= 35 ? "observable" : "latent",
    strength: clampScore(strength),
...
function buildWildTraceFact(homeMapState: HomeMapState): WorldEcologyFact {
  ...
  return {
    ...
    kind: "wild_trace",
    label: "野外活动迹象",
    status: strength >= 65 ? "emerging" : strength >= 35 ? "observable" : "latent",
    strength: clampScore(strength),
...
function buildClimateFact(homeMapState: HomeMapState): WorldEcologyFact {
  ...
  return {
    ...
    kind: "climate",
    label: "微气候舒适度",
    status: strength >= 70 ? "stable" : strength >= 30 ? "observable" : "latent",
    strength,
