...
8. 宠物未来能力保留，但只能通过 TownAdoptionPrecheck / ButlerAdoptionIntent / adoption_safe_apply 后置进入。
...
4. TownAdoptionPrecheck / ButlerAdoptionIntent。
...
6. 宠物未来能力保留。
7. 宠物只能通过 TownAdoptionPrecheck / ButlerAdoptionIntent / adoption_safe_apply 后置进入。
...
| TownAdoptionPrecheck / ButlerAdoptionIntent | 未完成 | 后续 LIFE-EVENT 模块。 |
...
5. TownAdoptionPrecheck / ButlerAdoptionIntent 后置候选协议。
...
7. TownAdoptionPrecheck / ButlerAdoptionIntent 后置候选入口。
...
�����Ѱ� MVP �ؽ����ջ��ӡ���ڴ��ڡ��ƽ�����ҳ�����չʾ����

1. `/create-world` ���޸�Ϊ�ɶ���������ҳ����ʹ���ȶ�����ʱ�������ʹ�� `Date.now`��
2. `/world` Ĭ��չʾ FormalWorldView������ Debug ��ͼ�л���
3. `/world` �ѽ��� `runAiPetWorldMvpPipeline` �� `buildMvpWorldViewModel`��չʾ MVP ����ڵ�ֻ��ժҪ����־��P-Phone������ժҪ�����ժҪ��
4. FormalWorldView ��Ȼֻ�� `FormalVisualModel`��������������ʵ��
5. ��������ģ���İ����޸�Ϊ��ʽ MVP �İ������ָ���Ĭ�ϳ��￪��·�ߡ�
...
������Ʒ���ص㲻�ټ�����Э�飬���Ƚ�����ʵ persistence adapter��world-loop scheduler��snapshot refresh adapter �� integration tests��

## VISUAL-DELIVERY-01 Formal World View Presentation ��ɼ�¼

VISUAL-DELIVERY-01 ����� `/world` ��ʽ���Ӿ��ͱ������ؼ�԰���ֽ�����

���׶����Ӿ����ֽ���������������ʵ���ɣ�

1. FormalWorldView ��Ȼֻ�� `FormalVisualModel`��
2. `/world` ��Ȼͨ����ʵ `RenderableWorldSnapshot -> buildFormalVisualModelFromSnapshot -> FormalWorldView` ��·չʾ��ʽ���Ӿ���
3. Debug ��ͼ��������Ĭ�����Ӿ��� FormalWorldView��
4. ���׶�û���޸��������ɡ�PlacementEngine��Construction��world-loop �� FormalVisualGenerator��
5. ���׶�û��Ĭ����ʾ���û�д��� pet actor / pet bed / pet_arrival / pet_rest��
...
�������ʵ��Ʒ����·��persistence adapter��world-loop scheduler��snapshot refresh adapter �� integration tests��
