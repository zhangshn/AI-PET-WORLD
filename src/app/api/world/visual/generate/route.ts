    ...
    return NextResponse.json(
      {
        ...
        messageEn: "The runtime world has not been created, so no world image candidate can be generated.",
    ...
    return NextResponse.json(
      {
        ...
        displayRuleEn: "The world image remains hidden until the internal model produces a real candidate that passes VisualJudge.",
        tags: [
  ...
  return NextResponse.json(
    {
      ...
      messageEn: "Internal model configuration exists, but project inference is not implemented and cannot generate a candidate.",
      imageModel: decision.imageModelStatus,
      canShowToPlayer: false,
      tags: [
        "world_visual_generate_api",
