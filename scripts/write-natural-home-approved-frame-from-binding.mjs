...
async function writeApprovedFrame() {
  ...
  const candidate = {
    ...
    generationNotes: text(
      "由本地小模型生成 256×192 源图，经 VJ-1 与最小 VJ-2 审核后，使用最近邻像素放大为 1024×768 正式帧，再进入 ApprovedFrame 写入闸门。",
      "Generated by the local small model at 256x192, reviewed by VJ-1 and minimal VJ-2, then nearest-neighbor scaled to a 1024x768 formal frame before the ApprovedFrame write gate.",
    ),
    worldId: world.worldId,
    tick: world.tick,
    tags: [
