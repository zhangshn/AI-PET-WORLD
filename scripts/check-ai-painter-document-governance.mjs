...
const exactDocumentVersions = new Map([
  ["docs/DOCUMENT_AUTHORITY_INDEX.md", "DOCUMENT-AUTHORITY-1.7"],
  ["docs/DOCUMENTATION_POLICY.md", "DOCUMENTATION-POLICY-1.3"],
  ["docs/BUSINESS_SPEC.md", "AI-PET-WORLD-BUSINESS-1.4"],
  ["docs/ARCHITECTURE.md", "AI-PET-WORLD-ARCHITECTURE-1.8"],
  ["docs/LOCAL_SELF_DEVELOPED_AI_CAPABILITY_AND_CODEX_MIGRATION_ARCHITECTURE.md", "LOCAL-AI-CAPABILITY-MIGRATION-1.6"],
  ["docs/DIRECTORY_STRUCTURE.md", "AI-PET-WORLD-DIRECTORY-1.11"],
  ["docs/game-world-generation/AI_PAINTER_FORMAL_IMPLEMENTATION_SPEC.md", "AI-PAINTER-SPEC-1.13"],
  ["docs/game-world-generation/TRAINING_DATA_AND_SOURCE_POLICY.md", "AI-PAINTER-DATA-PROVENANCE-1.5"],
