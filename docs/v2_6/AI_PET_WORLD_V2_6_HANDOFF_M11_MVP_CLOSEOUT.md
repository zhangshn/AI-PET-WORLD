...
| M11 核心资源库 / 验算库 | 进行中 | Runtime / HomeMapState / SpaceGrid / SpaceCell / TraceField / WorldViewModel / 生态对象 / Actor 表现输入边界已验收 |
...
Actor 表现输入必须来自 WorldViewModel，不得由 UI 或 Debug Composer 自行生成。
