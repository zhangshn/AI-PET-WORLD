...
def main() -> int:
    ...
    if args.output.exists():
        raise ValueError("native responsibility residual Smoke output exists")
    active = compile_native_responsibility_residual_smoke_active_config(
    ...
    print(json.dumps({
        "status": "native_responsibility_residual_smoke_active_config_compiled",
